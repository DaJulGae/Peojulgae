...
public class ChineseFragment extends Fragment {
    ...
    private String selectedCategory = "중식"; // 기본 카테고리
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        chineseRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        ...
        chineseRecyclerView.setAdapter(foodAdapter);
