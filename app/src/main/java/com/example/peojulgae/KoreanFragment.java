...
public class KoreanFragment extends Fragment {
    ...
    private String selectedCategory = "한식"; // 기본 카테고리
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        koreanRecyclerView = view.findViewById(R.id.koreanRecyclerView);
        koreanRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        ...
        koreanRecyclerView.setAdapter(foodAdapter);
